...
public class JwtFilter extends OncePerRequestFilter {
    ...
    @Override
    protected void doFilterInternal(HttpServletRequest request,//objeto que contiene toda la informacion que viene de React
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            try {
                Claims claims = Jwts.parser()
                        .setSigningKey(secretKey)// 1. Usas la LLAVE para abrir el sobre
